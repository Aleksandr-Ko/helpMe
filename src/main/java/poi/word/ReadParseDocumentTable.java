...
public class ReadParseDocumentTable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Iterate through the list and check for table element type - Перебрать список и проверить тип элемента таблицы
        while (docElementsIterator.hasNext()) {
            ...
            if ("TABLE".equalsIgnoreCase(docElement.getElementType().name())) {
                //Get List of table and iterate it - Получить список таблиц и повторить его
