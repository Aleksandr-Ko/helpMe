 ...
 *
 * Из 3 основных режимов обработки, которые поддерживает Jackson, потоковая обработка (также известная как инкрементная обработка) является наиболее эффективным способом
 * обрабатывать содержимое JSON. Он имеет наименьшие затраты памяти и обработки и часто может соответствовать производительности многих доступных двоичных форматов данных.
 * на платформе Java.
 *
